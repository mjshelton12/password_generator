...
if (window.confirm("Got it! Click Ok if you would like to include uppercase letters or Cancel if you don't.")){
...
if (window.confirm("We got you! Click Ok if you would like to include special characters (!@#$%^&*()) or Cancel if you don't.")){
  promptSpecial = ["!", "@", "#", "$", "%", "^", "&", "*", "(", ")"]
  } else {
  promptSpecial = []
}
